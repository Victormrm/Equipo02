 ...
 * Generated at: 2019-02-13 14:57:05 UTC
...
public final class fichajes_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input placeholder=\"yyyy-MM-dd\" type=\"text\"  pattern=\"([0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])\" name=\"fecha1\" id=\"fecha1\" data-error=\"Formato de fecha err&oacute;neo\" required/>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t <div class=\"help-block with-errors\"></div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<label>Introduzca segunda fecha del periodo de fichajes:<br></label> \n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input placeholder=\"yyyy-MM-dd\" type=\"text\" pattern=\"([0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])\" name=\"fecha2\" id=\"fecha2\" data-error=\"Formato de fecha err&oacute;neo\" required/>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t <div class=\"help-block with-errors\"></div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<h2>\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\" glyphicon glyphicon-asterisk\"></span> Gesti&oacuten de incidencias\n");
      out.write("\t\t\t\t\t\t\t\t</h2>\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/fichajes.jsp(224,12) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/fichajes.jsp(224,12) '${listafichajes}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${listafichajes}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      // /WEB-INF/views/fichajes.jsp(224,12) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
